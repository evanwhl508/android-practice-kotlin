...
class RecycleActivity() :AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
    var coins = ArrayList<Coin>()
    private var rvAdapter = DemoRVAdapter(this, coins)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getFilteredCoin().observe(this, {rvAdapter.setCoins(it)})
