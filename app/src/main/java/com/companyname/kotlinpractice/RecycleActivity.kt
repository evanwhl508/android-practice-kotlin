...
class RecycleActivity() : Fragment() {
    ...
    private var rvAdapter = DemoRVAdapter(this.context, coins)
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<ActivityRecycleBinding>(inflater, R.layout.activity_recycle, container, false)
